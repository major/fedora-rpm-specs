...
# https://github.com/boxgrinder/boxgrinder-build/pull/11
Patch0:      rubygem-boxgrinder-build-0.10.4-Fix-compatibility-with-recent-RSpec.patch
...
BuildRequires: rubygem(boxgrinder-core) >= 0.3.14
...
rm .%{gem_instdir}/integ/packages/*.rpm
...
* Sun Jun 08 2014 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.10.4-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_Mass_Rebuild

* Sun Aug 04 2013 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.10.4-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_20_Mass_Rebuild

* Mon Apr 08 2013 Vít Ondruch <vondruch@redhat.com> - 0.10.4-3
- Rebuild for https://fedoraproject.org/wiki/Features/Ruby_2.0.0

* Thu Feb 14 2013 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.10.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_19_Mass_Rebuild

* Tue Sep 4 2012 Marc Savy <msavy@redhat.com> - 0.10.4-1
- Upstream release: 0.10.4
- [BGBUILD-373] Remove hashery dependency

* Wed Aug 22 2012 Marek Goldmann <mgoldman@redhat.com> - 0.10.3-1
...
* Thu Jun 14 2012 Marek Goldmann <mgoldman@redhat.com> - 0.10.2-1
...
* Mon Mar 19 2012 Marek Goldmann <mgoldman@redhat.com> - 0.10.1-1
...
* Mon Dec 19 2011 Marek Goldmann <mgoldman@redhat.com> - 0.10.0-1
...
* Fri Nov 18 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.8-2
- Specifying required appliance-tools and rubygem-boxgrinder-core versions

* Tue Nov 15 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.8-1
...
* Sat Sep 10 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.7-1
...
* Mon Sep 05 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.6-1
...
* Fri Aug 26 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.5-1
...
* Wed Aug 17 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.4-1
...
* Tue Jun 28 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.3-2
- Added patch for one test
- Removed unnecessary dependencies

* Tue Jun 28 2011 Marc Savy <msavy@redhat.com> - 0.9.3-1
...
* Tue May 17 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.2-1
...
* Wed Apr 27 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.1-1
...
* Thu Mar 10 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.0-3
- Added rubygems require patch

* Thu Mar 10 2011 Marek Goldmann <mgoldman@redhat.com> - 0.9.0-2
...
* Tue Feb 22 2011 Marek Goldmann <mgoldman@redhat.com> - 0.8.1-1
