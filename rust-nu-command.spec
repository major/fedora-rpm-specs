...
# * replace unmaintained htmlescape with v_htmlescape
# * widen accepted rusqlite versions to allow building against 0.28 and 0.30
Patch:          nu-command-fix-metadata.diff
# ditto, see https://github.com/nushell/nushell/pull/11572
Patch:          nu-command-replace-htmlescape.diff
...
%cargo_test -- -- --skip debug::timeit::test_time_block --skip strings::split::words::test::test_incompat_flags --skip commands:: --skip format_conversions::
%endif
