...
Provides:        bundled(npm(@lumino/application)) = 2.0.0
Provides:        bundled(npm(@lumino/collections)) = 2.0.0
Provides:        bundled(npm(@lumino/commands)) = 2.0.0
Provides:        bundled(npm(@lumino/coreutils)) = 2.0.0
Provides:        bundled(npm(@lumino/datagrid)) = 2.0.0
...
Provides:        bundled(npm(@lumino/widgets)) = 2.0.0
