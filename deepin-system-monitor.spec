...
%build
%cmake -DCMAKE_BUILD_TYPE=RelWithDebInfo -DWAYLAND_SESSION_SUPPORT=OFF
%cmake_build
...
%{_sysconfdir}/xdg/autostart/%{name}-plugin-popup.desktop
...
%{_libdir}/dde-dock/plugins/lib%{name}-plugin.so
