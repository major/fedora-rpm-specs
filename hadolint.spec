...
%global monoidsubclasses monoid-subclasses-1.2.3
%global primes primes-0.2.1.0
%global timerep timerep-2.1.0.0
%global commutativesemigroups commutative-semigroups-0.1.0.1
%global subpkgs %{primes} %{commutativesemigroups} %{monoidsubclasses} %{timerep}
...
Source4:        https://hackage.haskell.org/package/%{commutativesemigroups}/%{commutativesemigroups}.tar.gz
