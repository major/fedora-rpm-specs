...
%cargo_test -- -- --skip config_ --skip fancy_default_errors --skip filesize_format_auto_metric_ --skip filesize_metric_ --skip narratable_errors --skip test_signature_same_name --skip test_signature_same_short
%endif
