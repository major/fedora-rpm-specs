...
# curl -L https://github.com/opensvc/multipath-tools/archive/0.9.7.tar.gz -o multipath-tools-0.9.7.tgz
Source0: multipath-tools-0.9.7.tgz
...
%prep
%autosetup -n multipath-tools-0.9.7 -p1
cp %{SOURCE1} .
