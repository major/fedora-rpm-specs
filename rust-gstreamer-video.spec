...
%if %{with check}
%check
# * skip a test that fails on big-endian architectures:
#   https://gitlab.freedesktop.org/gstreamer/gstreamer-rs/-/issues/491
%cargo_test -- -- --exact --skip video_format::tests::sort
%endif
