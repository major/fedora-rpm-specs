...
# Renamed from decnumber, remove once f35 and el8 are EOL
Provides:       decnumber-devel%{?_isa} = %{version}-%{release}
Obsoletes:      decnumber-devel < 1.0.0-5
Provides:       decnumber-static%{?_isa} = %{version}-%{release}
Obsoletes:      decnumber-static < 1.0.0-5
...
Obsoletes:      decnumber-doc < 1.0.0-5
