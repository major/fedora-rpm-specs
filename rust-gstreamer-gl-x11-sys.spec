...
License:        MIT
URL:            https://crates.io/crates/gstreamer-gl-x11-sys
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-x11-1.0) >= 1.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-x11-1.0) >= 1.16
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-x11-1.0) >= 1.18
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-x11-1.0) >= 1.20
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-x11-1.0) >= 1.22
...
echo 'pkgconfig(gstreamer-gl-x11-1.0) >= 1.14'
