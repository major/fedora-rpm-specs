...
Provides: bundled(golang(github.com/containers/image/v5)) = v5.30.0
...
Provides: bundled(golang(github.com/docker/docker)) = v25.0.4+incompatible
...
Provides: bundled(golang(google.golang.org/genproto/googleapis/rpc)) = v0.0.0_20231002182017_d307bd883b97
