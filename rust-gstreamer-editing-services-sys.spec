...
Name:           rust-gstreamer-editing-services-sys
Version:        0.21.0
Release:        %autorelease
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gst-editing-services-1.0) >= 1.20
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gst-editing-services-1.0) >= 1.22
...
echo 'pkgconfig(gst-editing-services-1.0) >= 1.14'
