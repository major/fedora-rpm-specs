...
License:        MIT
URL:            https://crates.io/crates/read_input
Source:         %{crates_source}


# Initial patched metadata
# * Removed dependencies as they are only needed in examples
...
Simple CLI tool that asks for user input until the data inputted is valid.}
...
# Upstream author shipped the examples, which are not needed for crate use and caused an additionnal unpackaged dependancy.
rm -rf examples
%cargo_prep
...
* Mon Apr 19 18:16:00 CEST 2021 Jean-Baptiste Trystram <jbtrystram@redhat.com> - 0.8.4-1
- Initial package
