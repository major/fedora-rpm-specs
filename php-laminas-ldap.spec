...
%description
%{namespace}\Ldap\Ldap is a class for performing LDAP operations including but
...
exit (class_exists("\\Zend\\%{library}\\Ldap") ? 0 : 1);
'
...
%changelog
* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.17.0-2
...
* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.11.0-3
