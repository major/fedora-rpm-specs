...
%prep
%setup -q -n %{gem_name}-%{version}-modified
mv ../%{gem_name}-%{version}*.gemspec ./%{gem_name}-%{version}.gemspec
...
LANG=C.UTF-8
ruby \
	-Ilib:.:%{buildroot}%{gem_extdir_mri}:test \
...
%{gem_extdir_mri}
%dir	%{gem_instdir}/
%doc	%{gem_instdir}/{CHANGELOG,README.md}
...
%changelog
* Fri Jul 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 0.8.6-42
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 0.8.6-41
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Wed Jan 04 2023 Mamoru TASAKA <mtasaka@fedoraproject.org> - 0.8.6-40
- Rebuild for https://fedoraproject.org/wiki/Changes/Ruby_3.2

* Sun Dec 25 2022 Mamoru TASAKA <mtasaka@fedoraproject.org> - 0.8.6-39
...
* Wed Jan 26 2022 Mamoru TASAKA <mtasaka@fedoraproject.org> - 0.8.6-36
- F-36: rebuild against ruby31

* Wed Jan 26 2022 Mamoru TASAKA <mtasaka@fedoraproject.org> - 0.8.6-35
- Clean up spec file (fix FTBFS with package_notes as a result)

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.8.6-34
