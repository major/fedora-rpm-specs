...
%global goipath         github.com/goji/httpauth
%global commit          2da839ab0f4df05a6db5eb277995589dadbd4fb9

%gometa

%global common_description %{expand:
Httpauth currently provides HTTP Basic Authentication middleware for Go. It is
compatible with Go's own net/http, goji, Gin & anything that speaks the
...
Version:        0
Release:        0.10%{?dist}
Summary:        HTTP authentication middlewares
...
* Mon Apr 29 18:09:30 CEST 2019 Robert-André Mauchin <zebob.m@gmail.com> - 0-0.1.20190625git2da839a
- Initial package
