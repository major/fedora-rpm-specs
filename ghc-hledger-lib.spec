...
%global breakpoint breakpoint-0.1.2.1
%global pager pager-0.1.1.0
%global textansi text-ansi-0.2.1.1
%global textbuilder text-builder-0.6.7
%global textbuilderdev text-builder-dev-0.3.3.2
%global deferredfolds deferred-folds-0.9.18.3
%global isomorphismclass isomorphism-class-0.1.0.9
%global subpkgs %{cassavamegaparsec} %{timeit} %{breakpoint} %{pager} %{deferredfolds} %{isomorphismclass} %{textbuilderdev} %{textbuilder} %{textansi}
...
Source4:        https://hackage.haskell.org/package/%{pager}/%{pager}.tar.gz
Source5:        https://hackage.haskell.org/package/%{textansi}/%{textansi}.tar.gz
Source6:        https://hackage.haskell.org/package/%{textbuilder}/%{textbuilder}.tar.gz
Source7:        https://hackage.haskell.org/package/%{textbuilderdev}/%{textbuilderdev}.tar.gz
Source8:        https://hackage.haskell.org/package/%{deferredfolds}/%{deferredfolds}.tar.gz
Source9:        https://hackage.haskell.org/package/%{isomorphismclass}/%{isomorphismclass}.tar.gz
Source10:       https://hackage.haskell.org/package/%{pkgver}/%{pkg_name}.cabal#/%{pkgver}.cabal
...
%setup -q -n %{pkgver} -a1 -a2 -a3 -a4 -a5 -a6 -a7 -a8 -a9
dos2unix -k -n %{SOURCE10} %{pkg_name}.cabal
# End cabal-rpm setup
(
