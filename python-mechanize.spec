...
# https://bugzilla.redhat.com/show_bug.cgi?id=2093940
# Backports from upstream git main
Patch0001:      0001-Use-asserts-for-failing-test-so-we-get-better-feedba.patch
Patch0002:      0002-DRYer.patch
Patch0003:      0003-Change-test-to-not-rely-on-order-of-cookie-iteration.patch
...
%changelog
* Fri Jan 26 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.8-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Mon Jan 22 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.8-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild
...
* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.8-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Fri Jul 22 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.8-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Sat Jul 16 2022 Miro Hrončok <mhroncok@redhat.com> - 0.4.8-4
- Ensure the mechanize python module is actually part of this package

* Thu Jun 23 2022 Adam Williamson <awilliam@redhat.com> - 0.4.8-3
- Backport patches from upstream to fix tests with Python 3.11 (#2093940)

* Tue Jun 14 2022 Python Maint <python-maint@redhat.com> - 0.4.8-2
- Rebuilt for Python 3.11

* Sun May 29 2022 Kevin Fenzi <kevin@scrye.com> - 0.4.8-1
- Update to 0.4.8. Fixes rhbz#2075578

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.7-1
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Mon Nov 08 2021 Mohan Boddu <mboddu@bhujji.com> - 0.4.7-0
- Rebuild 0.4.7

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.5-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Sun Jun 13 2021 Scott Talbert <swt@techie.net> - 0.4.5-7
- Fix FTBFS with Python 3.10 (#1899997)

* Fri Jun 04 2021 Python Maint <python-maint@redhat.com> - 0.4.5-6
- Rebuilt for Python 3.10

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.5-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild 

* Fri Jan 15 2021 Mohan Boddu <mboddu@bhujji.com> - 0.4.5-4
- Rebuild 0.4.5-4 on rawhide
