%global commit 8121b78fb8f87e869cbeca931964df2b32435eb7
%global commitdate 20200531
%{?commit:%global shortcommit %(c=%{commit}; echo ${c:0:7})}

Name:		radamsa
Version:	0.6^%{commitdate}.g%{shortcommit}
Release:	4%{?dist}
Summary:	A general-purpose fuzzer
License:	MIT 
URL:		https://gitlab.com/akihe/radamsa
%if %{defined commit}
Source0:        https://gitlab.com/akihe/radamsa/-/archive/%{commit}/%{name}-%{shortcommit}.tar.gz
%else
...
%prep
%autosetup -p1 -n %[0%{?commit:1}?"%{name}-%{commit}":"%{name}-v%{version}"]
...
%check
echo -e 'abc\ndef' >sample
bin/radamsa <sample | tee output1
bin/radamsa <sample | tee output2
...
%changelog
* Sat Jul 23 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.6^20200531.g8121b78-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.6^20200531.g8121b78-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.6^20200531.g8121b78-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Wed Jun 30 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 0.6^20200531.g8121b78-1
- Update to latest snapshot before transition to owl 0.2
