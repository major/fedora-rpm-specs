...
#+        "vimeo/psalm": "^4.6.4"
BuildRequires: (php-autoloader(%{gh_owner}/laminas-code)                 >= 4.7.1 with php-autoloader(%{gh_owner}/laminas-code)                 < 5)
...
%if ! %{bootstrap}
Requires:      (php-autoloader(%{gh_owner}/laminas-code)                 >= 4.7.1 with php-autoloader(%{gh_owner}/laminas-code)                 < 5)
