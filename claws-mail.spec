...
* Mon Jun 13 2022 Python Maint <python-maint@redhat.com> - 4.1.0-4
- Rebuilt for Python 3.11

* Wed Jun 01 2022 Jitka Plesnikova <jplesnik@redhat.com> - 4.1.0-3
- Perl 5.36 rebuild

* Thu May 26 2022 Michael Schwendt <mschwendt@fedoraproject.org> - 4.1.0-2
- Merge upstream fix to prepare for building with Perl 5.36.

* Sat Apr 23 2022 Michael Schwendt <mschwendt@fedoraproject.org> - 4.1.0-1
- Update to 4.1.0.
- New keyword_warner plugin.
- pdf_viewer patch not needed anymore.

* Wed Jan 19 2022 Fedora Release Engineering <releng@fedoraproject.org> - 4.0.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Wed Jul 21 2021 Fedora Release Engineering <releng@fedoraproject.org> - 4.0.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Tue Jul 20 2021 Michael Schwendt <mschwendt@fedoraproject.org> - 4.0.0-1
- Upgrade to 4.0.0.
- Build -fancy HTML rendering plugin again.
- Disable -dillo HTML rendering plugin because it crashes with Wayland
  and strictly requires X11.
- Build -python plugin again.
- Specify various BR in pkgconfig(foo) notation.
- Patch pdf_viewer plugin for deprecated ghostscript option. rhbz#1968349

* Sat May 22 2021 Jitka Plesnikova <jplesnik@redhat.com> - 3.17.8-5
- Perl 5.34 rebuild

* Mon Feb 15 2021 Michael Schwendt <mschwendt@fedoraproject.org> - 3.17.8-4
- Apply latest upstream commit for previous patch to be in sync with Clawsker.

* Mon Feb 15 2021 Michael Schwendt <mschwendt@fedoraproject.org> - 3.17.8-3
- Patch to use g_get_user_runtime_dir() instead of g_get_tmp_dir()

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 3.17.8-2
