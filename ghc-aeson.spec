...
%global indexedtraversableinstances indexed-traversable-instances-0.1.1.1
%global OneTuple OneTuple-0.3.1
%global semialign semialign-1.2.0.1
%global witherable witherable-0.4.2
%global subpkgs %{OneTuple} %{indexedtraversableinstances} %{semialign} %{witherable}

# testsuite missing deps: OneTuple quickcheck-instances tasty-golden
