...
Provides: bundled(golang(github.com/containerd/containerd)) = v1.6.6
Provides: bundled(golang(github.com/containerd/stargz_snapshotter/estargz)) = v0.12.0
Provides: bundled(golang(github.com/containers/buildah)) = v1.27.0
...
Provides: bundled(golang(github.com/containers/podman/v4)) = v4.2.1
...
Provides: bundled(golang(github.com/Microsoft/hcsshim)) = v0.9.3
...
Provides: bundled(golang(github.com/navidys/tvxwidgets)) = v0.1.1
Provides: bundled(golang(github.com/nxadm/tail)) = v1.4.8
Provides: bundled(golang(github.com/onsi/ginkgo/v2)) = v2.1.6
...
Provides: bundled(golang(github.com/sylabs/sif/v2)) = v2.7.1
