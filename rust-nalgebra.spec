...
# Remove features base on unsupported glam version
# Remove cuda and cust feature until rust-cuda is package
# Remove rkyv base features until nalgebra support the latest version
# Deactivate doctests as there are a missing function or item
# https://github.com/dimforge/nalgebra/issues/926
%bcond_without check
...
General-purpose linear algebra library with transformations and statically-
sized or dynamically-sized matrices.}
...
This package contains library source intended for building other packages which
use the "abomonation" feature of the "%{crate}" crate.
...
This package contains library source intended for building other packages which
use the "abomonation-serialize" feature of the "%{crate}" crate.
