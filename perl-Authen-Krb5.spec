...
%{__perl} Makefile.PL INSTALLDIRS=vendor OPTIMIZE="%build_cflags"
make %{?_smp_mflags}
...
%changelog
* Wed Aug 16 2023 Florian Weimer <fweimer@redhat.com> - 1.9-42
- Set build_type_safety_c to 0 (#2172836)
