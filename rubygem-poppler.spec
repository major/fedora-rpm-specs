...
# pdf needed for test file
# From 3.3.0, this is no longer needed
#Source1:	https://www.irs.gov/pub/irs-pdf/fw9.pdf
...
* Fri Feb  5 2016 Mamoru TASAKA <mtasaka@fedoraproject.org> - 3.0.7-4
- Fix build with poppler >= 0.39
