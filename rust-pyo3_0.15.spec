...
%if 0%{?fedora} >= 39
# tests fail with Python 3.12 due to ABI changes
%bcond_with check
%else
%bcond_without check
%endif
...
Patch:          0002-Fix-undefined-reference-when-building-against-Python.patch
...
%license %{crate_instdir}/src/ffi/LICENSE
