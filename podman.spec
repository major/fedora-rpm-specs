...
Provides: bundled(golang(github.com/Microsoft/hcsshim)) = v0.10.0_rc.7
...
Provides: bundled(golang(github.com/checkpoint_restore/checkpointctl)) = v0.1.0
...
Provides: bundled(golang(github.com/containerd/containerd)) = v1.7.0
...
Provides: bundled(golang(github.com/containers/buildah)) = v1.30.0
Provides: bundled(golang(github.com/containers/common)) = v0.52.0
...
Provides: bundled(golang(github.com/containers/libhvee)) = v0.0.2
...
Provides: bundled(golang(github.com/coreos/stream_metadata_go)) = v0.4.1
...
Provides: bundled(golang(github.com/docker/docker)) = v23.0.3+incompatible
...
Provides: bundled(golang(github.com/fsouza/go_dockerclient)) = v1.9.7
...
Provides: bundled(golang(github.com/go_playground/locales)) = v0.14.1
Provides: bundled(golang(github.com/go_playground/universal_translator)) = v0.18.1
Provides: bundled(golang(github.com/go_playground/validator/v10)) = v10.12.0
...
Provides: bundled(golang(github.com/google/trillian)) = v1.5.1
...
Provides: bundled(golang(github.com/klauspost/compress)) = v1.16.4
...
Provides: bundled(golang(github.com/leodido/go_urn)) = v1.2.2
...
Provides: bundled(golang(github.com/mattn/go_sqlite3)) = v1.14.16
...
Provides: bundled(golang(github.com/moby/term)) = v0.0.0_20221120202655_abb19827d345
...
Provides: bundled(golang(github.com/opencontainers/image_spec)) = v1.1.0_rc2.0.20221005185240_3a7f492d3f1b
...
Provides: bundled(golang(github.com/openshift/imagebuilder)) = v1.2.4
...
Provides: bundled(golang(github.com/sigstore/sigstore)) = v1.6.0
...
Provides: bundled(golang(github.com/sylabs/sif/v2)) = v2.11.1
...
Provides: bundled(golang(github.com/vbauerster/mpb/v8)) = v8.3.0
