...
Provides: bundled(golang(github.com/Azure/azure_sdk_for_go)) = v67.0.0+incompatible
...
Provides: bundled(golang(github.com/Azure/go_autorest/autorest/adal)) = v0.9.21
...
Provides: bundled(golang(github.com/ProtonMail/go_crypto)) = v0.0.0_20210428141323_04723f9f07d7
Provides: bundled(golang(github.com/acomagu/bufpipe)) = v1.0.3
Provides: bundled(golang(github.com/apex/log)) = v1.9.0
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2)) = v1.17.1
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/config)) = v1.17.10
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/credentials)) = v1.12.23
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/feature/ec2/imds)) = v1.12.19
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/internal/configsources)) = v1.1.25
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/internal/endpoints/v2)) = v2.4.19
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/internal/ini)) = v1.3.26
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/service/ecr)) = v1.17.20
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/service/ecrpublic)) = v1.13.19
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/service/internal/presigned_url)) = v1.9.19
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/service/sso)) = v1.11.25
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/service/ssooidc)) = v1.13.8
Provides: bundled(golang(github.com/aws/aws_sdk_go_v2/service/sts)) = v1.17.1
Provides: bundled(golang(github.com/aws/smithy_go)) = v1.13.4
Provides: bundled(golang(github.com/awslabs/amazon_ecr_credential_helper/ecr_login)) = v0.0.0_20221027043306_dc425bc05c64
Provides: bundled(golang(github.com/buildpacks/imgutil)) = v0.0.0_20221109161319_3252b1f13dfa
Provides: bundled(golang(github.com/buildpacks/lifecycle)) = v0.15.1
Provides: bundled(golang(github.com/chrismellard/docker_credential_acr_env)) = v0.0.0_20221002210726_e883f69e0206
...
Provides: bundled(golang(github.com/gdamore/tcell/v2)) = v2.5.3
Provides: bundled(golang(github.com/ghodss/yaml)) = v1.0.0
Provides: bundled(golang(github.com/go_git/gcfg)) = v1.5.0
Provides: bundled(golang(github.com/go_git/go_billy/v5)) = v5.3.1
Provides: bundled(golang(github.com/go_git/go_git/v5)) = v5.4.2
...
Provides: bundled(golang(github.com/moby/buildkit)) = v0.10.5
Provides: bundled(golang(github.com/moby/sys/mount)) = v0.3.3
Provides: bundled(golang(github.com/moby/sys/mountinfo)) = v0.6.2
Provides: bundled(golang(github.com/moby/term)) = v0.0.0_20221105221325_4eb28fa6025c
...
Provides: bundled(golang(github.com/xanzy/ssh_agent)) = v0.3.1
