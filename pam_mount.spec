...
Source0:        https://downloads.sourceforge.net/pam-mount/%{name}-%{version}.tar.xz
Source1:        https://downloads.sourceforge.net/pam-mount/%{name}-%{version}.tar.asc
# To be found at upstreams hoepage:  https://inai.de/about/
Source2:        pam_mount-gpgkey.gpg
...
%license LICENSE.GPL2 LICENSE.GPL3 LICENSE.LGPL2 LICENSE.LGPL3
