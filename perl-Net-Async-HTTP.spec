# remove after Net::Async::HTTP::Server is in repo; that module is needed for
# full tests in this module but that module depends on this module (this
# module will automatically skip those tests if it isn't found)
