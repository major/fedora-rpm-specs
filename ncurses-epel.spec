...
%files -n ncurses-compat-libs
%{_libdir}/lib*.so.5*

%changelog
* Fri Apr 28 2023 Michel Alexandre Salim <salimma@fedoraproject.org> - 6.2-8.20210508.1
- Fork to ship compat-libs in EPEL 9
