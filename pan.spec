...
BuildRequires:	gmime30-devel >= 3.0.0
BuildRequires:	gtk3-devel  >= 3.0.0
BuildRequires:	gtkspell3-devel >= 2.0.16
BuildRequires:	enchant2-devel >= 2.2.3
BuildRequires:	libappstream-glib
BuildRequires:	libnotify-devel >= 0.4.1
BuildRequires:	libsecret-devel >= 0.16
BuildRequires:	gcr-devel >= 3.20
...
%check
appstream-util validate-relax --nonet %{buildroot}/%{_datadir}/metainfo/org.gnome.%{name}.metainfo.xml
...
%{_bindir}/%{name}
%{_datadir}/icons/hicolor/*/apps/org.gnome.%{name}.png
...
* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.149-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Tue Dec 28 2021 Petr Kovar <pkovar@redhat.com> - 1:0.149-1
- Update to version 0.149

* Wed Sep 22 2021 Petr Kovar <pkovar@redhat.com> - 1:0.147-1
- Update to version 0.147
- Switch to GTK 3 and GMime 3

* Thu Jul 22 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.146-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.146-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Tue Jul 28 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.146-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Wed Jan 29 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.146-2
