...
%prep
%autosetup -n ntpd-rs-%{version_no_tilde} -p1
%cargo_prep
...
%if %{with check}
%check
# * skip a test that fails to panic in release mode
# * skip a test that fails in containerized environments
%cargo_test -- -- --skip algorithm::kalman::peer::tests::test_offset_steering_and_measurements --skip hwtimestamp::tests::get_hwtimestamp --skip socket::tests::test_send_timestamp
%endif
