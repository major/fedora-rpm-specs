...
%if %{with check}
BuildRequires:  (crate(unic-ucd-category/default) >= 0.9.0 with crate(unic-ucd-category/default) < 0.10.0)
%endif
...
%changelog
* Sat Jan 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 0.9.0-9
...
* Fri May 31 11:35:58 CEST 2019 Igor Gnatenko <ignatenkobrain@fedoraproject.org> - 0.9.0-1
- Initial package
