...
Patch3:		0001-gcc11.patch

# https://bugs.gentoo.org/708730
Patch4:		proper_uint8_t.patch
Patch5:		0001-PATCH-llvm-config.patch
Patch7:		0001-PATCH-Filter-out-cxxflags-not-supported-by-clang.patch

# Fixes GCC 12 build, newer llvm versions do the same, so...
Patch8:     0001-NVPTXAsmPrinter-drop-retturn-nullptr-for-unknown-typ.patch
...
%changelog
* Thu Jan 25 2024 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.1-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Sun Jan 21 2024 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.1-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Thu Jul 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.1-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Thu Jan 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.1-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Thu Jul 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Mon Dec 27 2021 Frantisek Zatloukal <fzatlouk@redhat.com> - 8.0.1-1
- Fix FTBFS
- Upgrade to 8.0.1

* Wed Jan 29 2020 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.0-12
