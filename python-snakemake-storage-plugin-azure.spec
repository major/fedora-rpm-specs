...
# Downstream-only: loosen the bounds on Azure dependencies to accommodate the
# versions currently packaged; it would be better to get these packages
# updated.
Patch:          loosen-azure-dependency-bounds.patch
