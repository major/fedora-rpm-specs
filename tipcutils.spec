...
Source0:    http://downloads.sourceforge.net/project/tipc/%{name}_%{version}.tgz
Patch0:     tipcutils-3.0.4-str_warnings.patch
Patch1:     tipcutils-3.0.4-format_errors.patch
