...
%package     -n %{name}+__private_hide_feature_deprecation_warning-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+__private_hide_feature_deprecation_warning-devel %{_description}

This package contains library source intended for building other packages which
use the "__private_hide_feature_deprecation_warning" feature of the "%{crate}" crate.

%files       -n %{name}+__private_hide_feature_deprecation_warning-devel
%ghost %{crate_instdir}/Cargo.toml

%package     -n %{name}+__private_legacy_default_serialization-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+__private_legacy_default_serialization-devel %{_description}

This package contains library source intended for building other packages which
use the "__private_legacy_default_serialization" feature of the "%{crate}" crate.

%files       -n %{name}+__private_legacy_default_serialization-devel
%ghost %{crate_instdir}/Cargo.toml
...
%package     -n %{name}+dep_csv-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+dep_csv-devel %{_description}

This package contains library source intended for building other packages which
use the "dep_csv" feature of the "%{crate}" crate.

%files       -n %{name}+dep_csv-devel
%ghost %{crate_instdir}/Cargo.toml

%package     -n %{name}+dep_ron-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+dep_ron-devel %{_description}

This package contains library source intended for building other packages which
use the "dep_ron" feature of the "%{crate}" crate.

%files       -n %{name}+dep_ron-devel
%ghost %{crate_instdir}/Cargo.toml

%package     -n %{name}+dep_toml-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+dep_toml-devel %{_description}

This package contains library source intended for building other packages which
use the "dep_toml" feature of the "%{crate}" crate.

%files       -n %{name}+dep_toml-devel
%ghost %{crate_instdir}/Cargo.toml
