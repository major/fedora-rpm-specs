...
%{_libdir}/libpdalcpp.so.17*
%{_libdir}/libpdal_plugin_kernel_fauxplugin.so.17*
%{_libdir}/libpdal_plugin_reader_pgpointcloud.so.17*
%{_libdir}/libpdal_plugin_writer_pgpointcloud.so.17*
