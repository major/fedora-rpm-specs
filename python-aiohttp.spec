...
# async_generator is for Python 3.5/3.6 compatibility and should be deprecated now
# https://github.com/python-trio/async_generator/issues/35#issuecomment-1242576699
sed -i -e 's/,async_generator//' setup.cfg
sed -i -e '/async-generator/d' tox.ini requirements/base.txt requirements/constraints.txt
