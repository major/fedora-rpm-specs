...
#  * Downgrade simple_logger to 1.x:
#    the dependency is only used for examples, and the code works with 1.x
...
%package     -n %{name}+wayland-commons-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+wayland-commons-devel %{_description}

This package contains library source intended for building other packages which
use the "wayland-commons" feature of the "%{crate}" crate.

%files       -n %{name}+wayland-commons-devel
%ghost %{crate_instdir}/Cargo.toml
