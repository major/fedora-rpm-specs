...
## audio calls
## FIXME, got orphaned/retired recently f33+ -- Rex
%if 0%{?fedora} < 33
...
* Fri Nov  6 15:21:52 CST 2020 Rex Dieter <rdieter@fedoraproject.org> - 20.08.3-1
- 20.08.3
...
* Thu Jun 18 2020 Rex Dieter <rdieter@fedoraproject.org> - 20.04.2-2
- drop dep on telepathy-rakia f33+ (#1837689)
- drop deprecated reference to telepathy-haze
