...
Source0:        https://github.com/SELinuxProject/selinux/releases/download/3.5-rc3/secilc-3.5-rc3.tar.gz
# fedora-selinux/selinux: git format-patch -N 3.5-rc3 -- secilc
