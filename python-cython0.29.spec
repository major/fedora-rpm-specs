...
# We don't ship emacs-cython-mode in the compat package
%bcond emacs 0
...
This package contains Cython 0.29.x for compatibility reasons.
Use Cython 3.0+ instead if at all possible.}

%description %{_description}


%package -n python3-cython0.29
Summary:        %{summary}
...
%py_provides    python3-Cython
%py_provides    python3-Cython0.29
%py_provides    python3-cython0.29
Conflicts:      python3-cython >= 1~~
Provides:       deprecated()
...
%description -n python3-cython0.29 %{_description}
...
%changelog
* Fri Jan 26 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.29.35-5
