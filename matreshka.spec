...
# on i686, tools/configure/configure-architecture.adb tries to detect sse2
# but it fails, workaround for it
sed -i tools/configure/configure-architecture.adb \
	-e '\@with GNAT.Regpat@{n;s|^.*$|with Ada.Text_IO;|}' \
	-e '\@support SSE builtins@s|Fatal_Error|Ada.Text_IO.Put_Line|' \
	%{nil}
...
%changelog
* Thu Jan 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 20.1-13
...
* Tue May  3 2022 Mamoru TASAKA <mtasaka@fedoraproject.org> - 20.1-10
...
* Thu Jul 22 2021 Fedora Release Engineering <releng@fedoraproject.org> - 20.1-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Fri May 21 2021 Max Reznik <reznikmm@gmail.com> - 20.1-7
- rebuilt with gcc-11.1.1-1

* Fri Apr 02 2021 Björn Persson <Bjorn@Rombobjörn.se> - 20.1-6
- rebuilt with gcc-11.0.1-0.3

* Mon Feb 08 2021 Pavel Raiskup <praiskup@redhat.com> - 20.1-5
- rebuild for libpq ABI fix rhbz#1908268

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 20.1-4
