...
Patch:          0002-drop-unknown-rustdoc-lint.patch
...
License:        CDDL-1.0 AND MIT AND (Apache-2.0 OR MIT) AND (Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT) AND (Unlicense OR MIT) AND (Zlib OR Apache-2.0 OR MIT)
...
%cargo_test -- -- --skip test_collapse_multi_dtrace --skip test_collapse_multi_perf --skip test_multiple_skip_after --skip test_one_skip_after
%endif
