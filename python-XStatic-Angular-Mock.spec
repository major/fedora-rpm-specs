%global pypi_name XStatic-Angular-Mock
...
%package -n xstatic-angular-mock-common
Summary:        %{summary}

BuildRequires:  web-assets-devel
Requires:       web-assets-filesystem

%description -n xstatic-angular-mock-common
JavaScript library packaged for setuptools (easy_install) / pip.
...
rmdir %{buildroot}%{python3_sitelib}/xstatic/pkg/angular_mock/data/
...
* Fri Oct 07 2016 Jan Beran <jberan@redhat.com> - 1.2.1.1-6
