...
Patch:          0001-Fix-cargo-registry-index-paths-for-big-endian-archit.patch
...
%cargo_test -- -- --exact --skip advisories::cfg::test::deserializes_advisories_cfg --skip bans::cfg::test::deserializes_ban_cfg --skip licenses::cfg::test::deserializes_licenses_cfg --skip licenses::gather::test::normalizes_line_endings --skip sources::cfg::test::deserializes_sources_cfg --skip test::cli_snapshot
%endif
