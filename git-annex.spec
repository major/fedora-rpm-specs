...
Source2:        https://git.joeyh.name/index.cgi/git-annex.git/plain/bash-completion.bash?h=%{version}#/bash-completion.bash
Source3:        https://git.joeyh.name/index.cgi/git-annex.git/plain/doc/index.mdwn?h=%{version}#/index.mdwn
Patch0:         %{name}-default-flags.patch
Patch1:         git-annex-9.4-unix.patch
...
cabal-tweak-dep-ver unix-compat '0.7' '0.8'
