...
%if %{with atlas}
install -p -m 755 binaries/system/libAtlasUI%{dbg}.so %{buildroot}%{_libdir}/%{name}/libAtlasUI%{dbg}.so
%endif
install -p -m 755 binaries/system/libCollada%{dbg}.so %{buildroot}%{_libdir}/%{name}/libCollada%{dbg}.so
