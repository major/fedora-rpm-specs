...
Provides: bundled(crate(anyhow)) = 1.0.44
...
Provides: bundled(crate(futures)) = 0.3.17
Provides: bundled(crate(futures-channel)) = 0.3.17
Provides: bundled(crate(futures-core)) = 0.3.17
Provides: bundled(crate(futures-executor)) = 0.3.17
Provides: bundled(crate(futures-io)) = 0.3.17
Provides: bundled(crate(futures-lite)) = 1.12.0
Provides: bundled(crate(futures-macro)) = 0.3.17
Provides: bundled(crate(futures-sink)) = 0.3.17
Provides: bundled(crate(futures-task)) = 0.3.17
Provides: bundled(crate(futures-util)) = 0.3.17
...
Provides: bundled(crate(http)) = 0.2.5
...
Provides: bundled(crate(libc)) = 0.2.105
...
Provides: bundled(crate(nix)) = 0.20.2
...
Provides: bundled(crate(ordered-float)) = 2.8.0
...
Provides: bundled(crate(prometheus)) = 0.13.0
...
Provides: bundled(crate(reqwest)) = 0.11.6
...
Provides: bundled(crate(structopt)) = 0.3.25
...
Provides: bundled(crate(tokio)) = 1.13.0
...
Provides: bundled(crate(zbus)) = 1.9.2
Provides: bundled(crate(zbus_macros)) = 1.9.2
Provides: bundled(crate(zvariant)) = 2.9.0
Provides: bundled(crate(zvariant_derive)) = 2.9.0
%endif
