...
Patch0:         0001-Add-missing-parameter-to-lu1rec-calls.patch
# Fix use of an uninitialized value
# https://github.com/nwh/lusol/pull/12
Patch1:         0002-Give-zero-a-value-before-use-in-lu8mod.patch
# Fix a race when building lusol.o
# https://github.com/nwh/lusol/pull/14
Patch2:         0003-Fix-race-when-building-src-lusol.o.patch
