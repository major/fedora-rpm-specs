...
# # * The following PR would fix the missing license file in future crate
# #   releases:
# # * Add the LICENSE file to the lz4-sys crate
# # * https://github.com/10XGenomics/lz4-rs/pull/40
Source10:       https://github.com/BLAKE3-team/BLAKE3/raw/%{version}/LICENSE
...
Patch10:       lz4-sys-1.9.4-system-liblz4.patch
