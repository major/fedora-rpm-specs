...
# Unreleased patches from upstream
Patch0:         %{srcname}-0.1.0-Skip-tests-requiring-debian-on-other-platforms.patch
Patch1:         %{srcname}-0.1.0-Explicitly-fix-script-permissions-after-copying.patch
