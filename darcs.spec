...
cabal-tweak-dep-ver base '< 4.16' '< 4.18'
...
cabal-tweak-dep-ver fgl '< 5.8' '< 5.9'
cabal-tweak-dep-ver hashable '< 1.4' '< 1.5'
cabal-tweak-dep-ver memory '< 0.17' '< 0.19'
cabal-tweak-dep-ver regex-tdfa '< 1.3.2' '< 1.4'
cabal-tweak-dep-ver text '< 1.3' '< 2.2'
cabal-tweak-dep-ver time '< 1.10' '< 1.13'
cabal-tweak-dep-ver unix-compat '< 0.6' '< 0.8'
