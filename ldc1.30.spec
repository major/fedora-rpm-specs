...
Source0:        https://github.com/ldc-developers/ldc/releases/download/v%{version}%{?pre:-%{pre}}/ldc-%{version}%{?pre:-%{pre}}-src.tar.gz
...
%prep
%autosetup -n ldc-%{version}%{?pre:-%{pre}}-src -p1
