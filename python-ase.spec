...
# https://gitlab.com/ase/ase/-/issues/868
rm -f ase/test/constraints/test_fixinternals.py

# Remove tests which use distutils https://gitlab.com/ase/ase/-/issues/909
rm -f ase/test/calculator/dftb/test_dftb_bandstructure.py
rm -f ase/test/calculator/openmx/test_md.py
rm -f ase/test/calculator/openmx/test_version.py
rm -f ase/test/fio/test_openmx.py
...
# https://gitlab.com/ase/ase/-/merge_requests/2818
rm -f ase/test/db/test_db_web.py
...
LC_ALL=C.UTF-8 python -m ase test --verbose --pytest -W ignore -W 'once::DeprecationWarning'
cd -
