...
This package contains library source intended for building other packages which
use the "backtraces" feature of the "%{crate}" crate.
...
%package     -n %{name}+backtraces-impl-std-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+backtraces-impl-std-devel %{_description}

This package contains library source intended for building other packages which
use the "backtraces-impl-std" feature of the "%{crate}" crate.

%files       -n %{name}+backtraces-impl-std-devel
%ghost %{crate_instdir}/Cargo.toml
...
%package     -n %{name}+rust_1_39-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+rust_1_39-devel %{_description}

This package contains library source intended for building other packages which
use the "rust_1_39" feature of the "%{crate}" crate.

%files       -n %{name}+rust_1_39-devel
%ghost %{crate_instdir}/Cargo.toml
...
This package contains library source intended for building other packages which
use the "unstable-backtraces-impl-std" feature of the "%{crate}" crate.
