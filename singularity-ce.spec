...
Provides: bundled(golang(github.com/containerd/containerd)) = v1.6.16
...
Provides: bundled(golang(github.com/fatih/color)) = v1.14.1
...
Provides: bundled(golang(github.com/ProtonMail/go_crypto)) = v0.0.0_20230201104953_d1d05f4e2bfb
...
Provides: bundled(golang(github.com/sylabs/scs_build_client)) = v0.7.6
...
Provides: bundled(golang(github.com/sylabs/sif/v2)) = v2.9.1
...
Provides: bundled(golang(github.com/urfave/cli)) = v1.22.7
...
Provides: bundled(golang(github.com/vbauerster/mpb/v8)) = v8.1.6
