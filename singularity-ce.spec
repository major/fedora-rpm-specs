...
Provides: bundled(golang(github.com/google/uuid)) = v1.4.0
...
Provides: bundled(golang(github.com/sigstore/sigstore)) = v1.7.5
...
Provides: bundled(golang(github.com/vbauerster/mpb/v8)) = v8.6.2
