...
Provides: bundled(golang(github.com/containers/image/v5)) = v5.24.2
...
Provides: bundled(golang(github.com/klauspost/compress)) = v1.16.0
...
Provides: bundled(golang(github.com/pelletier/go_toml/v2)) = v2.0.7
...
Provides: bundled(golang(github.com/safchain/ethtool)) = v0.2.0
Provides: bundled(golang(github.com/seccomp/libseccomp_golang)) = v0.10.0
Provides: bundled(golang(github.com/secure_systems_lab/go_securesystemslib)) = v0.5.0
...
Provides: bundled(golang(github.com/sylabs/scs_build_client)) = v0.7.7
Provides: bundled(golang(github.com/sylabs/scs_key_client)) = v0.7.2
Provides: bundled(golang(github.com/sylabs/scs_library_client)) = v1.4.4
Provides: bundled(golang(github.com/sylabs/sif/v2)) = v2.11.0
