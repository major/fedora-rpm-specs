...
# Depends:
# Imports:   R-cli, R-crayon >= 1.3.4, R-ellipsis >= 0.3.2, R-fansi, R-lifecycle, R-rlang >= 0.3.0, R-utf8 >= 1.1.0, R-utils, R-vctrs >= 0.3.8
# Suggests:  R-bit64, R-debugme, R-DiagrammeR, R-dplyr, R-formattable, R-ggplot2, R-knitr, R-lubridate, R-nycflights13, R-palmerpenguins, R-rmarkdown, R-scales, R-stringi, R-survival, R-testthat >= 3.0.2, R-tibble, R-units >= 0.7.2, R-withr
# LinkingTo:
# Enhances:
