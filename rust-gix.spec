...
Patch:          gix-fix-metadata-auto.diff
...
%package     -n %{name}+reqwest-for-configuration-only-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+reqwest-for-configuration-only-devel %{_description}

This package contains library source intended for building other packages which
use the "reqwest-for-configuration-only" feature of the "%{crate}" crate.

%files       -n %{name}+reqwest-for-configuration-only-devel
%ghost %{crate_instdir}/Cargo.toml
