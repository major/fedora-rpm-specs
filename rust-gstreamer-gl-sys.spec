...
echo 'pkgconfig(gstreamer-gl-1.0) >= 1.14'
...
%if %{with check}
%check
# Disable tests on s390x until we update to 0.21 where the failing tests are
# all disabled.
# See https://gitlab.freedesktop.org/gstreamer/gstreamer-rs/-/commit/130805fc50dba5a0e578fa92a60352f44c715b52
%ifnarch s390x
%cargo_test
%endif
%endif
