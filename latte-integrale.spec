...
Source2:        https://github.com/latte-int/latte-distro/raw/master/lidia-LA-%{lidiaver}+latte-patches-%{lidiadate}.tar.gz
Source3:        https://github.com/latte-int/latte-distro/raw/master/lidia-base-%{lidiaver}+latte-patches-%{lidiadate}.tar.gz
