...
%build
%configure --with-systemdsystemunitdir=%{_unitdir} --with-systemduserunitdir=%{_userunitdir}
%make_build
...
%preun
%systemd_preun fleet-commander-client.service fleet-commander-clientad.service
%systemd_user_preun fleet-commander-adretriever.service

%post
%systemd_post fleet-commander-client.service fleet-commander-clientad.service
%systemd_user_post fleet-commander-adretriever.service

%postun
%systemd_postun_with_restart fleet-commander-client.service fleet-commander-clientad.service
...
%changelog
* Wed Jan 24 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Wed Jul 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-14
...
* Wed Jan 26 2022 Oliver Gutierrez <ogutierrez@redhat.com> - 0.15.0-11
- Added systemd to build requirements

* Wed Jan 26 2022 Oliver Gutierrez <ogutierrez@redhat.com> - 0.15.0-10
- Fixed configure call

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Wed Jul 21 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Tue Mar 02 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 0.15.0-7
- Rebuilt for updated systemd-rpm-macros
  See https://pagure.io/fesco/issue/2583.

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-6
