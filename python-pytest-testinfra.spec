...
%changelog
* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 6.8.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Fri Jul 22 2022 Fedora Release Engineering <releng@fedoraproject.org> - 6.8.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Tue Jun 28 2022 Chedi Toueiti <chedi.toueiti@gmail.com> - 6.8.0-1
- Update to version 6.8.0 (#2099410)

* Thu Jun 16 2022 Python Maint <python-maint@redhat.com> - 6.7.0-2
- Rebuilt for Python 3.11

* Mon May 16 2022 Chedi Toueiti <chedi.toueiti@gmail.com> - 6.7.0-1
- Update to version 6.7.0 (#2074697)

* Mon Apr 04 2022 Chedi Toueiti <chedi.toueiti@gmail.com> - 6.6.0-1
- Update to version 6.6.0 (#2053398)

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 6.5.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Sat Dec 18 2021 Chedi Toueiti <chedi.toueiti@gmail.com> - 6.4.0-1
- Update to version 6.5.0 (#2029992)

* Thu Nov 25 2021 Maxwell G <gotmax@e.email> - 6.4.0-2
- Support both ansible and ansible-core.

* Wed Sep 01 2021 Chedi Toueiti <chedi.toueiti@gmail.com> - 6.4.0-1
- Update to version 6.4.0 (#1950749)

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 6.2.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Fri Jun 04 2021 Python Maint <python-maint@redhat.com> - 6.2.0-2
