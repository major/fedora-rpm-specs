...
License: GPLv3+
URL: https://fedorahosted.org/bharati/
Source: https://fedorahosted.org/releases/b/h/bharati/bharati-m17n-1.2.tar.gz
...
%description
bharati is an enhancement to input method based on InScript layout and
implements unique transformation rule of deleting on the fly the previous
dependent vowel for Indic languages. 

%prep
%setup -q -n bharati-m17n-%{version}
...
%changelog
* Wed Jul 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-20
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Wed Jan 19 2022 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-19
...
* Thu Jul 12 2018 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Wed Feb 07 2018 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Wed Jul 26 2017 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Fri Feb 10 2017 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_Mass_Rebuild

* Wed Feb 03 2016 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-8
...
* Fri Mar 25 2011 Sandeep Shedmake <sandeeps@fedoraproject.org> - 1.2-1
- Added index.html

* Fri Mar 18 2011 Sandeep Shedmake <sandeeps@fedoraproject.org> - 1.1-1
- Initial packaging
