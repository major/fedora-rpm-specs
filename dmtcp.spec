...
Source0:	https://sourceforge.net/projects/%{name}/files/2.6.1/%{name}-%{version}.tar.gz
BuildRequires:	gcc-c++
...
* Fri Sep 09 2022 Filipe Rosset <rosset.filipe@gmail.com> - 2.6.1~rc2-0.4
- Disabled tests to fix FTBFS on Fedora 36+

* Thu Jul 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.1~rc2-0.3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.1~rc2-0.2
