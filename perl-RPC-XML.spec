...
# lib/Apache/RPC/Server.pm: Artistic 2.0 or LGPLv2
# lib/Apache/RPC/Status.pm: Artistic 2.0 or LGPLv2
# lib/RPC/XML.pm:   Artistic 2.0 or LGPLv2
# lib/RPC/XML/Client.pm:    Artistic 2.0 or LGPLv2
# lib/RPC/XML/Parser.pm:    Artistic 2.0 or LGPLv2
# lib/RPC/XML/ParserFactory.pm: Artistic 2.0 or LGPLv2
# lib/RPC/XML/Parser/XMLLibXML.pm:  Artistic 2.0 or LGPLv2
# lib/RPC/XML/Parser/XMLParser.pm:  Artistic 2.0 or LGPLv2
# lib/RPC/XML/Procedure.pm:     Artistic 2.0 or LGPLv2
# lib/RPC/XML/Server.pm:    Artistic 2.0 or LGPLv2
...
BuildRequires:  perl(LWP::UserAgent) >= 6.51
# Tests:
...
%global __requires_exclude %{?__requires_exclude:%__requires_exclude|}^perl\\(Module::Load|Scalar::Util|XML::LibXML|XML::Parser\\)\\s*$
