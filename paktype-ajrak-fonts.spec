...
Source0:	https://sourceforge.net/p/paktype/code/HEAD/tree/Fonts/Release/PakType-Ajrak-6.0.tar.gz?format=raw#/%{name}-%{version}.tar.gz
...
* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 6.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Thu Jul 22 2021 Fedora Release Engineering <releng@fedoraproject.org> - 6.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Mon Mar 01 2021 Vishal Vijayraghavan <vishalvvr@fedoraproject.org> - 6.0-4
- Update Source URL

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 6.0-3
