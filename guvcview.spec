...
# Get fixed license file while we wait for upstream
## Cf. https://sourceforge.net/p/guvcview/tickets/73/
...
# Replace COPYING data with the correct file
cp %{SOURCE1} COPYING
...
%files libs
%license COPYING
%{_libdir}/libgviewaudio-2.0.so.%{somajor}{,.*}
%{_libdir}/libgviewencoder-2.1.so.%{somajor}{,.*}
%{_libdir}/libgviewrender-2.1.so.%{somajor}{,.*}
%{_libdir}/libgviewv4l2core-2.1.so.%{somajor}{,.*}
