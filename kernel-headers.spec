...
%changelog
* Mon Nov 27 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.7.0-0.rc3.git0.1
- Linux v6.7-rc3.git0

* Mon Nov 20 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.7.0-0.rc2.git0.1
- Linux v6.7-rc2.git0
...
* Mon Oct 16 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.6.0-0.rc6.git0.1
- Linux v6.6-rc6.git0

* Mon Oct 09 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.6.0-0.rc5.git0.1
- Linux v6.6-rc5.git0

* Mon Oct 02 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.6.0-0.rc4.git0.1
- Linux v6.6-rc4.git0

* Mon Sep 25 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.6.0-0.rc3.git0.1
- Linux v6.6-rc3.git0

* Mon Sep 18 2023 Justin M. Forbes <jforbes@fedoraproject.org> - 6.6.0-0.rc2.git0.1
- Linux v6.6-rc2.git0
