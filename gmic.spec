...
%global gmic_qt_version 20230503git111f461
%global gmic_community_version 20230530gitf90cf6ae
...
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/libcgmic.so.325
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/libgmic.so.325
