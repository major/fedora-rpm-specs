...
# * Remove foreign winegl feature. Normally we'd use rust2rpm.conf to exclude
#   unwanted features, but in this crate, rust2rpm errors out when parsing the
#   winegl feature so we need to patch it before rust2rpm sees it to work this
#   around.
