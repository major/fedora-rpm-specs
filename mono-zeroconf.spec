...
%prep
%setup -q
%patch0 -p1 -b .system-dbus
%patch1 -p1 -b .hostbyteordere
%patch2 -p1 -b .prefix
%patch3 -p1 -b .dnsfix
%patch4 -p1 -b .ipv6fix
%patch5 -p1 -b .unreliable
%patch6 -p1 -b .recursivedispose
%patch7 -p1 -b .namecollision
%patch8 -p1 -b .utf8
%patch9 -p1 -b .hosttarget
%patch10 -p1 -b .dbusfix
%patch11 -p1 -b .2017
